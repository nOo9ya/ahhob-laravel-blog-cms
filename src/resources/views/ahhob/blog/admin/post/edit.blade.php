        ...
        <div class="max-w-4xl mx-auto">
            <div class="bg-white rounded-lg shadow-md p-6">
                <div class="flex justify-between items-center mb-6">
                    <h1 class="text-2xl font-bold text-gray-900">게시물 수정</h1>
                        ...
                        <div class="lg:col-span-2 space-y-6">
                            ...
                            <div>
                                ...
                                <textarea name="excerpt" id="excerpt" rows="3"
                                          class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                          placeholder="게시물의 간단한 요약을 입력하세요">{{ old('excerpt', $post->excerpt) }}</textarea>
                            </div>
                            ...
                            <div class="border-t pt-6">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="meta_description" id="meta_description" rows="2"
                                              class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                              placeholder="검색 엔진에 표시될 설명을 입력하세요">{{ old('meta_description', $post->meta_description) }}</textarea>
                                </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="bg-gray-50 p-4 rounded-lg">
                                ...
                                <div class="mb-4">
                                    ...
                                    <select name="status" id="status" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                        <option value="draft" {{ old('status', $post->status) == 'draft' ? 'selected' : '' }}>임시저장</option>
                                ...
                                <div>
                                    <label class="flex items-center">
                                        <input type="checkbox" name="comments_enabled" value="1" {{ old('comments_enabled', $post->comments_enabled) ? 'checked' : '' }}
                                        class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            ...
                            <div class="bg-gray-50 p-4 rounded-lg">
                                ...
                                @if($post->featured_image)
                                    <div class="mb-2">
                                        <img src="{{ Storage::url($post->featured_image) }}" alt="현재 썸네일" class="w-full h-32 object-cover rounded">
                                        <p class="text-sm text-gray-500 mt-1">현재 썸네일</p>
                                    </div>
                                @endif
                            ...
                            <div class="bg-gray-50 p-4 rounded-lg">
                                ...
                                @if($post->og_image)
                                    <div class="mb-2">
                                        <img src="{{ Storage::url($post->og_image) }}" alt="현재 OG 이미지" class="w-full h-32 object-cover rounded">
                                        <p class="text-sm text-gray-500 mt-1">현재 OG 이미지</p>
                                    </div>
                                @endif
